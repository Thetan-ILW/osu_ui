...
function View:searchUpdated()
	local text = self.search ~= "" and self.search or self.selectView.localization.text.SongSelection_TypeToBegin
	self.searchFormat[4] = text
	self.searchLabel:replaceText(self.searchFormat)
	self.selectView:updateSearch(self.search)
end
...
function View:load()
	...
	self.search = select_view.configs.select.filterString
	...
	function chart_name:update()
		...
		chart_name.alpha = easing.linear(select_view.notechartChangeTime, 0.2)
	...
	function chart_source:update()
		...
		chart_source.alpha = easing.linear(select_view.notechartChangeTime, 0.25)
	...
	function first_row:update()
		...
		first_row.alpha = easing.linear(select_view.notechartChangeTime, 0.3)
	...
	function second_row:update()
		...
		second_row.alpha = easing.linear(select_view.notechartChangeTime, 0.4)
	...
	function third_row:update()
		...
		third_row.alpha = easing.linear(select_view.notechartChangeTime, 0.5)
